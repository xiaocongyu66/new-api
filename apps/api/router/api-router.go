...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.POST("/karmada/session", middleware.RootAuth(), middleware.DisableCache(), controller.CreateKarmadaDashboardSession)
		...
		apiRouter.GET("/rankings", middleware.HeaderNavModuleAuth("rankings"), ginadapter.Handler(controller.GetRankings))
