...
// the schemes existing clients send: dashboard JWTs, personal access tokens,
// and relay API keys all arrive through this header. Anything else is rejected
// so a malformed header can never be interpreted as a valid credential.
//
