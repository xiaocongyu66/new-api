...
func channelHasSensitiveChanges(channel *PatchChannel, origin *channelpkg.Channel, requestData map[string]any) bool {
...
// field is added to channelpkg.Channel it must be added to either this set or
