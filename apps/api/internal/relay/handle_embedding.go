...
func EmbeddingHelper(c contract.Context, info *relaycommon.RelayInfo) (newAPIError *types.NewAPIError) {
	...
	logger.LogDebug(c.Context(), "converted embedding request body: %s", jsonData)
