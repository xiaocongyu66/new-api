...
func GeminiResponsesHandler(c contract.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.NewAPIError) {
	...
	logger.LogDebug(c.Context(), "Gemini responses response body: %s", responseBody)
...
func GeminiResponsesStreamHandler(c contract.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.NewAPIError) {
